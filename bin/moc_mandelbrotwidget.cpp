...
#include "../src/mandelbrotwidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_MandelbrotWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 54, 10)
    ...
    "scaleFactor\0zoom\0zoomFactor\0"
};
...
const QMetaObject MandelbrotWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MandelbrotWidget.data,
      qt_meta_data_MandelbrotWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MandelbrotWidget.stringdata))
